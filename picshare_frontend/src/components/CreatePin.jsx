              ...
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  <div className='flex flex-col justify-center items-center'>
                    <p className='font-bold flex-2xl'>
            ...
            <div>
              ...
              <select onChange={(e) => setCategory(e.target.value)} className='outline-none w-4/5 text-base border-b-2 border-gray-200 p-2 rounded-md cursor-pointer'>
                ...
                {categories.map((category) => (
                  <option value={category.name} className='text-base text-black border-0 outline-none capitalize bg-white'>{category.name}</option>
                ))}
              </select>
            </div>
